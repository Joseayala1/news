...
var QueryEvents = /** @class */ (function (_super) {
    ...
    function QueryEvents(args) {
        ...
        _this.setValIfNotDefault("minArticlesInEvent", minArticlesInEvent, undefined);
...
var QueryEventsIter = /** @class */ (function (_super) {
    ...
    QueryEventsIter.prototype.iterate = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Object.defineProperty(QueryEventsIter.prototype, "current", {
        get: function () {
    ...
    QueryEventsIter.prototype.getNextBatch = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestEventsInfo = new RequestEventsInfo({
                            page: this.page,
                            count: 50,
                            sortBy: this.sortBy,
...
var RequestEventsInfo = /** @class */ (function (_super) {
    ...
    function RequestEventsInfo(args) {
        ...
        var _a = args.page, page = _a === void 0 ? 1 : _a, _b = args.count, count = _b === void 0 ? 50 : _b, _c = args.sortBy, sortBy = _c === void 0 ? "rel" : _c, _d = args.sortByAsc, sortByAsc = _d === void 0 ? false : _d, _e = args.returnInfo, returnInfo = _e === void 0 ? undefined : _e;
        if (page < 1) {
...
var RequestEventsConceptGraph = /** @class */ (function (_super) {
    ...
    function RequestEventsConceptGraph(args) {
        ...
        var _a = args.conceptCount, conceptCount = _a === void 0 ? 25 : _a, _b = args.linkCount, linkCount = _b === void 0 ? 150 : _b, _c = args.eventsSampleSize, eventsSampleSize = _c === void 0 ? 50000 : _c, _d = args.returnInfo, returnInfo = _d === void 0 ? new returnInfo_1.ReturnInfo() : _d;
...
var RequestEventsConceptTrends = /** @class */ (function (_super) {
    ...
    function RequestEventsConceptTrends(args) {
        ...
        var _a = args.conceptCount, conceptCount = _a === void 0 ? 10 : _a, _b = args.conceptUris, conceptUris = _b === void 0 ? [] : _b, _c = args.returnInfo, returnInfo = _c === void 0 ? new returnInfo_1.ReturnInfo() : _c;
        if (conceptCount > 50) {
...
var RequestEventsSourceAggr = /** @class */ (function (_super) {
    ...
    function RequestEventsSourceAggr(args) {
        ...
        var _a = args.sourceCount, sourceCount = _a === void 0 ? 30 : _a, _b = args.eventsSampleSize, eventsSampleSize = _b === void 0 ? 50000 : _b, _c = args.returnInfo, returnInfo = _c === void 0 ? new returnInfo_1.ReturnInfo() : _c;
        if (sourceCount > 200) {
